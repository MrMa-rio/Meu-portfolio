function scrollPage(numero){
    ...
    const selectSection = ["aboutMe","myProjects","Me","cordelContainer","socialContainer","loginContainer","calculatorContainer","snakeContainer","mySecondGameContainer","myContacts"]
